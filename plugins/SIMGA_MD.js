////////////////////////////////////////////////////////////////////////////////////////////////////////////  const os = require('os')
    ...
    let buttonMessaged = {
      ...
      contextInfo: {
        externalAdReply: {
          ...
          mediaType: 1,
          mediaUrl: '',
          sourceUrl: `https://wa.me/2349027862116` + owner + '?text=Hii+bro,I+am+' + person.pushName
        }
      }
    };
  ...
  sɪɢᴍᴀ_ᴍᴅ.Module_Exports({
    ...
    try {
      ...
      let _0x372184 = "┏━━「 " + mztit + " 」━━▣      \n┃⁞卐. *ᗷOT OᗯᑎEᖇ* " + name.ownername + "\n┃⁞卐. *ᑭᖇEᖴI᙭ ᕼᗩᑎᗪᒪEᖇ* 『 *" + prefix + "* 』\n┃⁞卐. *TᕼEᗰE* " + tlang().theme + "\n┃⁞卐. *ᗰOᗪE* " + name.WORKTYPE + "\n┃⁞卐. *TIᗰE ᑎOᗯ* " + _0x393cfa + "\n┃⁞❏. *ᗪᗩTE* " + _0x20e8d6 + "\n┃⁞卐. *ᖇᗩᗰ* " + formatp(os.totalmem() - os.freemem()) + '/' + formatp(os.totalmem()) + "\n┃⁞卐. *ʀᴜɴᴛɪᴍᴇ* " + runtime(process.uptime()) + "\n┃⁞卐. *ᴘʟᴜɢɪɴs* " + _0x3442f9.length + "\n┃⁞卐. *ᔕᑭEEᗪ* " + latensie.toFixed(4) + " ᴍs\n┃⁞卐. *ᑭᒪᗩTᖴOᖇᗰ* ᴍᴀᴄ-ᴏs\n┃⁞卐. *ᐯEᖇᔕIOᑎ* " + name.VERSION + "\n┗━━━━━━━━━━━▣       \n\n" + sɪɢᴍᴀ_readmore + "\n";
      let _0x33ce6e = false;
